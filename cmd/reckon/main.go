...
// install's secrets — the Keycloak master-admin password lands in the secret
// store, generated by default or supplied via --kc-admin-password / KC_ADMIN_PW.
// Idempotent — re-running against an existing config reports it and ensures the
// secret exists without rotating it.
