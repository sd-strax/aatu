...
func TestMain(m *testing.M) {
	...
	testHandler = aggregate.NewHandler(aggregate.NewStore(testDB), aggregate.InvestigationCurrentProjector{}, aggregate.ActionCurrentProjector{}, aggregate.ReasoningNodeProjector{}).
...
func resetInvestigations(t *testing.T) {
	...
	if _, err := testDB.Exec(`TRUNCATE events, investigation_current, action_current, hypothesis_current, prediction_current, stix_objects`); err != nil {
